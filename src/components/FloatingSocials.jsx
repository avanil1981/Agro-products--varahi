...
export default function FloatingSocials() {
  return (
    <div className="fixed left-0 top-1/2 -translate-y-1/2 z-[60] flex flex-col gap-3 py-4 px-2.5 bg-white/95 backdrop-blur-sm shadow-[4px_0_20px_rgba(0,0,0,0.08)] rounded-r-xl border border-l-0 border-gold-accent/30 transition-transform duration-300 hidden md:flex">
      {/* Facebook */}
      <a 
