        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 pb-12 border-b border-white/10">
          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-3 pt-3">
              <a href="https://www.facebook.com/profile.php?id=61590916154503" target="_blank" rel="noopener noreferrer" className="bg-white/5 border border-white/10 hover:border-gold-accent hover:bg-gold-accent p-2 rounded-full transition-all shadow-sm group/social" title="Facebook">
