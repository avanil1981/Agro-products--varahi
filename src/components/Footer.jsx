        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 pb-12 border-b border-white/10">
          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-3 pt-3">
              ...
              <a href="https://www.instagram.com/srivarahiagrofoodsllp/" target="_blank" rel="noopener noreferrer" className="bg-white/5 border border-white/10 hover:border-gold-accent hover:bg-gold-accent hover:text-dark-green text-cream-bg p-2 rounded-full transition-all shadow-sm group/social">
              ...
              <a href="https://www.linkedin.com/in/sri-varahi-agro-foods-llp-726820418" target="_blank" rel="noopener noreferrer" className="bg-white/5 border border-white/10 hover:border-gold-accent hover:bg-gold-accent hover:text-dark-green text-cream-bg p-2 rounded-full transition-all shadow-sm group/social">
